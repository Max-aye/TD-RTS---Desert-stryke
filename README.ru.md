...
<p>
  ...
  <a href="./TERRA2136_PLAY_v0.99.0.html">⬇ Игровая сборка v0.99.0</a> ·
...
1. Откройте [`index.html`](./index.html) или напрямую [`TERRA2136_PLAY_v0.99.0.html`](./TERRA2136_PLAY_v0.99.0.html).
...
├── TERRA2136_PLAY_v0.99.0.html        # актуальная офлайн-сборка

...
<p align="center">
  ...
  <a href="./TERRA2136_PLAY_v0.98.1.html"><img src="https://img.shields.io/badge/⬇%20Playable%20Build-v0.98.1-7AE582?style=for-the-badge" alt="Playable build" /></a>
...
3. Or run the bundled build directly: [`TERRA2136_PLAY_v0.98.1.html`](./TERRA2136_PLAY_v0.98.1.html).
...
├── TERRA2136_PLAY_v0.98.1.html       # playable offline build
...
```bash
python3 tools/split.py TERRA2136_PLAY_v0.98.1.html parts/
```
...
| `0.99.0` | Styles and tech debt | 🔧 Planned |
...
[**▶ Open the game**](./index.html) · [**⬇ Playable build**](./TERRA2136_PLAY_v0.98.1.html) · [**🗺 Roadmap**](./docs/ROADMAP.md)
